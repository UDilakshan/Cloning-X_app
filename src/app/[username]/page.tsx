  ...
  return (
    <div className="">
      ...
      <div className="flex items-center gap-8 sticky top-0 backdrop-blur-md p-4 z-10 bg-[#00000084]">
        ...
        <h1 className="font-bold text-lg">Dilakshan Uthayakumar</h1>
      </div>
      ...
      <div className="">
        ...
        <div className="relative w-full">
          ...
          <div className="w-full aspect-[3/1] relative">
            <Image path="general/Back.png" alt="" w={800} h={200} tr={true} />
          </div>
        ...
        <div className="p-4 flex flex-col gap-2">
          {/* USERNAME & HANDLE */}
          <div className="">
            <h1 className="text-2xl font-bold">U Dilakshan</h1>
            <span className="text-textGray text-sm">@DiluWebDev</span>
          </div>
          <p>Dilakshan Youtube Channel</p>
